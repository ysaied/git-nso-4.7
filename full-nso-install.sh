...
if [ -d /var/tmp/ncs-downloads ]; then sudo rm -r /var/tmp/ncs-downloads && echo "var/tmp/ncs-downloads directory deleted"; fi
...
wget --no-check-certificate -O /var/tmp/ncs-downloads/nso-4.7.linux.x86_64.signed.bin -L https://cisco.box.com/shared/static/sxuxink81v3klkwkjx2edbe9c5eekhyp.bin > /dev/null
...
wget --no-check-certificate -O /var/tmp/ncs-downloads/ncs-4.7-alu-sr-7.10.signed.bin -L https://cisco.box.com/shared/static/vq56lc76qoomyesqcgerk5sva0of6ehm.bin > /dev/null
...
wget --no-check-certificate -O /var/tmp/ncs-downloads/ncs-4.7-viptela-vmanage-1.2.2.signed.bin -L https://cisco.box.com/shared/static/dy15l1apk5c51bf2h69izf4p4f2v7uxg.bin > /dev/null
